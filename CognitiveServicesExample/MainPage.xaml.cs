...
namespace CognitiveServicesExample
{
    ...
    {
        private const string _subscriptionKey = "79a6a2f5ce0349738f22a10566b027c4";
        private const string _serviceEndpoint = "https://si-faceapi.cognitiveservices.azure.com/";
        ...
        private void DisplayParsedResults(DetectedFace[] resultList)
        {
            ...
            foreach (DetectedFace face in resultList)
            {
                ...
                textToDisplay += "Persona número: " + (index+1).ToString() + " " + emotionString + "\n";
                index++;
            }
